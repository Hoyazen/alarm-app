        ...
        <div className={styles.buttonsDisplay}>
            <div className={styles.buttonsContainer}>
                <div className={darkMode ? `${styles.button} ${styles.buttonDark}` : `${styles.button} ${styles.buttonLight}`}>
                    <p className={darkMode ? `${styles.iconText} ${styles.iconTextDark}` : `${styles.iconText} ${styles.iconTextLight}`}>10</p>
                </div>
                <div className={darkMode ? `${styles.button} ${styles.buttonDark}` : `${styles.button} ${styles.buttonLight}`}>
                    <p className={darkMode ? `${styles.iconText} ${styles.iconTextDark}` : `${styles.iconText} ${styles.iconTextLight}`}>20</p>
                </div>
                <div className={darkMode ? `${styles.button} ${styles.buttonDark}` : `${styles.button} ${styles.buttonLight}`}>
                    <p className={darkMode ? `${styles.iconText} ${styles.iconTextDark}` : `${styles.iconText} ${styles.iconTextLight}`}>30</p>
                </div>
            </div>
            <div className={styles.buttonsContainer}>
                <div className={darkMode ? `${styles.button} ${styles.buttonDark}` : `${styles.button} ${styles.buttonLight}`}>
